...
function Hero() {
    ...
    return (
        <div className="Hero-content">
            ...
            <p>
                I build modern, scalable web applications using React, Django, Java and Spring Boot.
            </p>
